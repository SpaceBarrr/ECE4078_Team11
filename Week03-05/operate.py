...
if __name__ == "__main__":
    ...
    parser.add_argument("--ip", metavar='', type=str, default='localhost')       # original is 192.168.50.1
    parser.add_argument("--port", metavar='', type=int, default=40000)           # SIM 40000, ROBOT 8080
