...
if __name__ == "__main__":
    ...
    parser.add_argument("--ip", metavar='', type=str, default='192.168.50.1')      # original is 'localhost'
    parser.add_argument("--port", metavar='', type=int, default=8080)   #original is 40000
