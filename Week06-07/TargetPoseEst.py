...
def estimate_pose(camera_matrix, obj_info, robot_pose):
    ...
    target_dimensions_dict = {'Orange': [0.0963,0.0871,0.0892], 'Lemon': [0.091,0.0642,0.0651], ## SWAP BACK FOR FAKE FRUIT 'Orange': [0.077,0.078,0.074], 'Lemon': [0.070,0.051,0.053]
